...
- obj:
  ...
  Passed to
  [BenchmarkAggr](https://mlr3benchmark.mlr-org.com/dev/reference/BenchmarkAggr.md)`$new()`.

- task_id, learner_id, independent, strip_prefix:

  See
  [BenchmarkAggr](https://mlr3benchmark.mlr-org.com/dev/reference/BenchmarkAggr.md)`$initialize()`.
